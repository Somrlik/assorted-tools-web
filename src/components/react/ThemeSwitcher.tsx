...
export function ThemeSwitcher() {
    ...
    function switchTheme() {
        ...
        setTheme(newTheme);
        window.localStorage.setItem('assorted_tools_theme', newTheme);
    }

    return (<a title="Switch light/dark mode" id="theme-switcher" href="#" onClick={(e) => {e.preventDefault();switchTheme();}}>
        {theme === 'dark' && <SVGStringWrapper width="3em" height="3em" svg={ICON_LIGHT}/>}
        {theme === 'light' && <SVGStringWrapper width="3em" height="3em" svg={ICON_DARK}/>}
    </a>);
}
