    ...
    return (
        <>
            {isClipboardAvailable() &&
                <button onClick={() => writeToClipboard(props.data)} title="Copy to clipboard">
                    <SVGStringWrapper width="1em" height="1em" svg={COPY_TO_CLIPBOARD_ICON}/>
                </button>
            }
        </>
    );
